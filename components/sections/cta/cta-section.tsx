...
export function CTASection() {
  return (
    <section className="py-20 bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 bg-[radial-gradient(circle_at_bottom,var(--color-primary-100)_0%,transparent_50%)] opacity-80 dark:opacity-40" />
      
      <div className="container">
        <div className="relative rounded-3xl border border-primary/20 bg-linear-to-br from-emerald-950 to-teal-900 px-6 py-12 text-center text-white shadow-2xl overflow-hidden md:py-20 md:px-12">
          {/* Subtle grid in container */}
          <div className="absolute inset-0 -z-10 bg-[linear-gradient(to_right,#ffffff03_1px,transparent_1px),linear-gradient(to_bottom,#ffffff03_1px,transparent_1px)] bg-size-[16px_16px] mask-[radial-gradient(ellipse_60%_50%_at_50%_50%,#000_70%,transparent_100%)]" />
