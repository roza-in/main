...
export function Comparison({ competitorName, tagline, description, features }: ComparisonProps) {
  ...
  return (
    <div className="py-20 md:py-24 bg-background relative overflow-hidden">
      ...
      <div className="container max-w-5xl text-left">
        ...
        <div className="max-w-3xl space-y-4 mb-16">
          ...
          <h1 className="text-display text-3xl sm:text-4xl md:text-5xl">
            {tagline}
          </h1>
        ...
        <div className="rounded-xl border border-rose-500/20 bg-rose-500/5 p-6 flex items-start gap-4 mb-12">
        ...
        {/* Table comparison */}
        <div className="rounded-xl border border-border bg-card shadow-xs overflow-hidden mb-16">
          <table className="w-full border-collapse text-left text-sm">
            <thead>
              <tr className="border-b border-border bg-muted/40">
                <th className="p-4 font-bold text-foreground w-[45%] text-xs sm:text-sm">Feature Description</th>
                <th className="p-4 font-extrabold text-primary text-center bg-primary/5 text-xs sm:text-sm">Rozx</th>
        ...
        <div className="rounded-xl border border-border bg-surface-1 p-6 flex flex-col md:flex-row items-center justify-between gap-6">
